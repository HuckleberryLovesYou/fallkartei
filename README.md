...
<p align="center">
  <img alt="Version 1.0.1" src="https://img.shields.io/badge/Version-1.0.1-f2f3f5?style=flat-square&labelColor=11141a&color=f2f3f5">
...
**Version 1.0.1** ist der aktuelle stabile Release. **Version 1.0.0** war der erste konsolidierte Release unter dem Namen **Die Fallkartei**. Die App wird hauptsächlich für den privaten Gebrauch und einen kleinen Freundeskreis entwickelt. Das Repository ist öffentlich, damit GitHub Pages die App bereitstellen kann und der technische Aufbau nachvollziehbar bleibt.
